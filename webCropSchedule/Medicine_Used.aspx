<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Medicine_Used.aspx.cs" Inherits="webCropSchedule.Medicine_Used" %>
   ...
   <div class="container position-relative">
     ...
     <nav class="breadcrumbs">
       <ol>
         ...
         <li class="current">Medicine Used</li>
       </ol>
     </nav>
   </div>
 </div><!-- End Page Title -->
   ...
   <div class="row gy-5 gx-lg-5">
      ...
      <form id="form1" class="php-email-form" runat="server">
        <div class="row">
            ...
            <asp:Label ID="Label1" runat="server" Text="Medicine ID" class="form-label"></asp:Label>
            ...
            <asp:Label ID="Label4" runat="server" Text="Qty Used" class="form-label"></asp:Label>
            <asp:TextBox ID="txtQtyUsed" runat="server" class="form-control"></asp:TextBox>
