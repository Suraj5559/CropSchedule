<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Water_Used.aspx.cs" Inherits="webCropSchedule.Water_Used" %>
   ...
   <div class="row gy-5 gx-lg-5">
      ...
      <form id="form1" class="php-email-form" runat="server">
        <div class="row">
            ...
            <asp:Label ID="Label1" runat="server" Text="Water ID" class="form-label"></asp:Label>
            <asp:TextBox ID="txtWaterId" runat="server" class="form-control"></asp:TextBox>
            ...
            <asp:DropDownList ID="ddlCropName" runat="server" class="form-control"></asp:DropDownList>
             ...
             <asp:Label ID="Label5" runat="server" Text="Hours" class="form-label"></asp:Label>
             <asp:TextBox ID="txtHours" runat="server" class="form-control"></asp:TextBox>
